...
<div class="row">
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div style="border-style:dashed;border-color:red;text-align:center;color:red">
            ...
            <h2>ALERTE SANITAIRE</br>Coronavirus COVID-19</h2>
            <p>
				Sacrés Pangolins de tes grands morts. 
            </p>
        </div>
    </div>
</div>
				...
				<form action="###" method="post">
					...
					<div class="form-example-int form-horizental">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<input id="addmailcontact" type="text" class="form-control input-sm" placeholder="Email" requiered>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-example-int form-horizental mg-t-15">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
									<div class="nk-int-st">
										<textarea type="text" id="msgcontact" name="message" rows="5" class="form-control md-textarea"></textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-example-int mg-t-15">
						<div class="row">
							...
							<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
								<button class="btn btn-success notika-btn-success waves-effect">Envoyer</button>
							</div>
						</div>
					</div>
				</form>
