...
class ManagementBddTreatments extends crud {
    ...
    public function add_treatment(Treatments $treatment){
        $query = $this->getDb()->prepare('INSERT INTO treatments (t_aid, t_tag, t_cis, t_start_date, t_end_date, t_quantity, t_number_day, t_time, t_validate) 
            VALUES (:t_aid, :t_tag, :t_cis, :t_start_date, :t_end_date, :t_quantity, :t_number_day, :t_time, :t_validate)');
    ...
    public function update_treatment(Treatments $treatment){
        $query = $this->getDb()->prepare('UPDATE treatments 
            SET t_aid = :t_aid, t_tag = :t_tag, t_cis = :t_cis, t_start_date = :t_start_date, t_end_date = :t_end_date, t_quantity = :t_quantity, t_number_day = :t_number_day, t_time = :t_time, t_validate = :t_validate
            WHERE t_id = :t_id');
