...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  `c_alpha2` varchar(2) NOT NULL,
  `c_alpha3` varchar(3) NOT NULL,
  `c_name_en` varchar(45) NOT NULL,
  `c_name_fr` varchar(45) NOT NULL,
  PRIMARY KEY (`c_id`),
  UNIQUE KEY `alpha2` (`c_alpha2`),
  UNIQUE KEY `alpha3` (`c_alpha3`),
...
INSERT INTO `countries` (`c_id`, `c_code`, `c_alpha2`, `c_alpha3`, `c_name_en`, `c_name_fr`) VALUES
